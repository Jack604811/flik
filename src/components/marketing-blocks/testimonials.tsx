...
export const TestimonialCard = ({
  ...
  <div
    className={cn(
      ...
      "border border-neutral-200 bg-white", // light styles
      "dark:bg-black dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]", // dark styles
      className,
    )}
    {...props}
  >
