...
const tooltipContent = {
  ...
  units: "The total number of spots/tickets available for booking",
      ...
      <Form {...form}>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div
              {...getRootProps()}
              className={`relative flex h-44 w-full cursor-pointer flex-col items-center justify-center rounded-md border border-dashed ${
