    ...
    <div className="w-full">
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            className={cn("w-full justify-between px-2 h-16")}
          >
            {selectedSpot ? (
        ...
        <PopoverContent className="p-0" aria-labelledby="spot-selector-title">
          <Command className="max-h-[400px] overflow-hidden">
            ...
            />
            <CommandList>
              <CommandEmpty>No spot found</CommandEmpty>
              <CommandGroup>
