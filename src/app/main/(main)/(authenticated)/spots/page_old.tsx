    ...
    <div className="flex-1 p-6 pt-4 space-y-8 md:p-8 md:pt-6">
      {spots.length ? (
        <Card className="bg-green-600">
          ...
          <CardContent>
          <div>
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 justify-items-start items-start bg-red-200">
              {spots.map((spot) => (
                    <div
