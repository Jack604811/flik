...
const customFields: CustomField[] = [
  { id: "1", name: "Customer Type", type: "input", createdBy: "email@gmail.com", dateCreated: "2023-06-01" },
  { id: "2", name: "Birthday", type: "date", createdBy: "email@gmail.com", dateCreated: "2023-06-15" },
  { id: "3", name: "Loyalty Score", type: "number", createdBy: "email@gmail.com", dateCreated: "2023-07-01" },
];
              ...
              <Table className="min-w-full">
                <TableHeader>
                  <TableRow className="whitespace-nowrap border-b border-gray-200 dark:border-gray-700">
                    ...
                    <TableHead className="text-gray-900 dark:text-white">Created By</TableHead>
